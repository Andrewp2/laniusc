...
impl<'gpu> GpuCompiler<'gpu> {
    ...
    fn record_x86_from_parse_buffers_with_codegen(
        ...
        let inputs = x86::RecordElfInputs {
            ...
            function_metadata: x86::GpuX86FunctionMetadataBuffers {
                ...
                method_decl_name_token: codegen.method_decl_name_token,
            ...
            call_metadata: x86::GpuX86CallMetadataBuffers {
                ...
                compact_hir_count: &parse_bufs.hir.count,
                compact_hir_core: &parse_bufs.hir.core,
                compact_hir_links: &parse_bufs.hir.links,
                compact_hir_payload: &parse_bufs.hir.payload,
                compact_call_arg_count: &parse_bufs.hir.call_arg_count,
                compact_call_args: &parse_bufs.hir.call_args,
            ...
            array_metadata: x86::GpuX86ArrayMetadataBuffers {
                ...
                compact_hir_core: &parse_bufs.hir.core,
                compact_hir_payload: &parse_bufs.hir.payload,
                compact_element_start: &parse_bufs.hir.array_element_start,
                compact_element_count: &parse_bufs.hir.array_element_count,
                compact_element_row_count: &parse_bufs.hir.array_element_row_count,
                compact_elements: &parse_bufs.hir.array_elements,
            },
            enum_metadata: x86::GpuX86EnumMetadataBuffers {
                ...
                compact_hir_links: &parse_bufs.hir.links,
                compact_hir_payload: &parse_bufs.hir.payload,
                compact_variant_count: &parse_bufs.hir.variant_count,
                compact_variants: &parse_bufs.hir.variants,
                compact_variant_payload_count: &parse_bufs.hir.variant_payload_count,
                compact_match_arm_count: &parse_bufs.hir.match_arm_count,
                compact_match_arms: &parse_bufs.hir.match_arms,
                compact_match_payload_start: &parse_bufs.hir.match_payload_start,
                compact_match_payload_count: &parse_bufs.hir.match_payload_count,
                compact_match_payload_row_count: &parse_bufs.hir.match_payload_row_count,
                compact_match_payloads: &parse_bufs.hir.match_payloads,
                hir_token_pos: &parse_bufs.hir_token_pos,
                path_count_out: codegen.path_count_out,
                path_id_by_owner_hir: codegen.path_id_by_owner_hir,
                resolved_value_decl: codegen.resolved_value_decl,
            ...
            struct_metadata: x86::GpuX86StructMetadataBuffers {
                ...
                compact_hir_core: &parse_bufs.hir.core,
                compact_hir_payload: &parse_bufs.hir.payload,
                compact_field_count: &parse_bufs.hir.field_count,
    ...
    fn x86_external_scratch_from_frontend_buffers<'a>(
        ...
        x86::GpuX86ExternalScratchBuffers {
            ...
            func_slot_by_node: None,
            match_pattern_owner: None,
            match_pattern_node_owner: None,
            match_pattern_node_variant: None,
            match_pattern_node_payload_decl: None,
            match_pattern_first_use_node: None,
...
fn x86_backend_execution_failed_for_source(
    ...
    if std::env::var("LANIUS_X86_STATUS_TRACE").is_ok() {
        eprintln!("[laniusc][x86-error] {err}");
    }
    ...
    match err {
        GpuTypeCheckError::Rejected {
            ...
            if std::env::var_os("LANIUS_DEBUG_STAGE_ERRORS").is_some() {
                eprintln!(
                    "GPU x86 source-pack type-check rejection: token={token} code={code:?} detail={detail}"
                );
            }
