...
fn diagnostic_runtime_api_for_selector(
    ...
    Option<&'static str>,
    Option<&'static crate::compiler::RuntimeBoundApiDiagnosticInfo>,
) {
...
fn diagnostic_runtime_service_boundary_for_selector(
    ...
    Option<&'static str>,
    Option<&'static crate::compiler::RuntimeServiceBoundaryDiagnosticInfo>,
) {
...
fn runtime_service_selector_examples_json() -> serde_json::Value {
    serde_json::json!({
        "service_id": crate::compiler::GPU_SOURCE_PACK_RUNTIME_SERVICE_STDIO_ID,
        "service_name": "stdio",
        "module_path": "std::io",
