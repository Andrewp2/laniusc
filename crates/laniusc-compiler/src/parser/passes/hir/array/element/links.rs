...
crate::gpu::passes_core::impl_static_shader_pass!(
    HirArrayElementLinksPass,
    label: "hir_array_element_links",
    shader: "parser/hir/array/element/links"
);

impl Pass<ParserBuffers, crate::parser::debug::DebugOutput> for HirArrayElementLinksPass {
    const NAME: &'static str = "hir_array_element_links";
    ...
    fn create_resource_map<'a>(
        ...
        HashMap::from([
            ...
            (
                "hir_array_element_link_a".into(),
                b.hir_array_element_link_a.as_entire_binding(),
            ),
            (
            ...
            (
                "hir_array_element_owner_b".into(),
                b.hir_array_element_owner_b.as_entire_binding(),
            ),
            (
                "hir_array_element_link_b".into(),
                b.hir_array_element_link_b.as_entire_binding(),
            ),
            (
