...
/// Uniform parameters for member expression span extraction.
pub struct Params {
    pub n: u32,
    pub uses_status_count: u32,
}

/// Pass that records source spans for member expressions.
pub struct HirMemberSpansPass {
    data: PassData,
}

crate::gpu::passes_core::impl_static_shader_pass!(
    HirMemberSpansPass,
    label: "hir_member_spans",
    shader: "parser/hir/member/spans"
);

impl Pass<ParserBuffers, crate::parser::debug::DebugOutput> for HirMemberSpansPass {
    const NAME: &'static str = "hir_member_spans";
