...
/// Uniform parameters for member and index expression materialization.
pub struct Params {
    pub n: u32,
...
pub struct HirPostfixFieldsPass {
    data: PassData,
}

crate::gpu::passes_core::impl_static_shader_pass!(
    HirPostfixFieldsPass,
    label: "hir_postfix_fields",
    shader: "parser/hir/postfix_fields"
);

impl Pass<ParserBuffers, crate::parser::debug::DebugOutput> for HirPostfixFieldsPass {
    const NAME: &'static str = "hir_postfix_fields";
