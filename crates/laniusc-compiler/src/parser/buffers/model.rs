...
pub struct ParserBuffers {
    ...
    pub token_block_scan_plan: TokenBlockScanPlan,
    ...
    pub pack_offset_scan_plan: PackOffsetScanPlan,
    ...
    pub b02_scan_plan: TokenBlockScanPlan,
    ...
    pub hir_member_fields_params: LaniusBuffer<super::super::passes::hir::postfix_fields::Params>,
    ...
    pub hir_array_fields_params: LaniusBuffer<super::super::passes::hir::array::Params>,
    pub hir_enum_match_fields_params: LaniusBuffer<super::super::passes::hir::enums::Params>,
    ...
    pub hir_semantic_prefix_scan: crate::gpu::operations::InclusiveBlockScanPlan,
    pub hir_canonical_prefix_scan: crate::gpu::operations::InclusiveBlockScanPlan,
