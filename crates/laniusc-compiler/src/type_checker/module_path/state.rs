...
pub(in crate::type_checker) struct BindGroups {
    ...
    pub(in crate::type_checker) path_prefix_initial_table_clear: wgpu::BindGroup,
    ...
    pub(in crate::type_checker) clear_import_visible_type_lookup: wgpu::BindGroup,
    pub(in crate::type_checker) clear_import_visible_value_lookup: wgpu::BindGroup,
