...
pub(in crate::type_checker) struct TypeInstanceBindGroups {
    ...
    pub(in crate::type_checker) sort_struct_field_key_bucket_local: Vec<wgpu::BindGroup>,
    pub(in crate::type_checker) sort_struct_field_key_bucket_chunks: Vec<wgpu::BindGroup>,
    pub(in crate::type_checker) sort_struct_field_key_bucket_apply: Vec<wgpu::BindGroup>,
    pub(in crate::type_checker) struct_field_radix_prefix_work_items: u32,
    ...
    pub(in crate::type_checker) semantic_type_scan: Box<U32ScanBindGroups>,
    pub(in crate::type_checker) semantic_type_scan_n_blocks: u32,
...
pub(in crate::type_checker) struct CallBindGroups {
    ...
    pub(in crate::type_checker) clear_generic_claim_type_args: wgpu::BindGroup,
