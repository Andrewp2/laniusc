...
struct TypeCheckPasses {
    ...
    type_instances_finalize_generic_param_flags: PassData,
...
pub struct GpuSemanticInterfaceHirBuffers<'a> {
    ...
    pub hir_type_arg_owner: &'a wgpu::Buffer,
    pub hir_type_arg_rank: &'a wgpu::Buffer,
    pub hir_type_arg_count: &'a wgpu::Buffer,
    pub hir_type_form: &'a wgpu::Buffer,
    pub hir_type_value_node: &'a wgpu::Buffer,
    pub hir_type_len_token: &'a wgpu::Buffer,
    pub hir_type_len_value: &'a wgpu::Buffer,
    pub hir_fn_return_type_node: &'a wgpu::Buffer,
    pub hir_type_alias_target_node: &'a wgpu::Buffer,
    pub hir_stmt_record: &'a wgpu::Buffer,
    pub hir_param_record: &'a wgpu::Buffer,
    pub hir_param_type_node: &'a wgpu::Buffer,
    pub hir_struct_field_parent_struct: &'a wgpu::Buffer,
    pub hir_struct_field_type_node: &'a wgpu::Buffer,
    pub hir_variant_payload_count: &'a wgpu::Buffer,
    pub hir_variant_payload_node: &'a wgpu::Buffer,
    pub hir_variant_parent_enum: &'a wgpu::Buffer,
    pub hir_variant_ordinal: &'a wgpu::Buffer,
    pub hir_struct_field_ordinal: &'a wgpu::Buffer,
    pub hir_struct_decl_field_count: &'a wgpu::Buffer,
}
