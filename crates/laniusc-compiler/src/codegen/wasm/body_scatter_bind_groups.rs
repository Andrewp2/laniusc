...
pub(super) struct WasmBodyScatterBindGroups {
    ...
    pub hir_body_scatter_if_simple_bind_group: wgpu::BindGroup,
    ...
    pub hir_body_scatter_arrays_bind_group: wgpu::BindGroup,
    ...
    pub hir_body_scatter_member_expr_bind_group: wgpu::BindGroup,
