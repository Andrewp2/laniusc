...
pub(super) fn record_status_trace_readback(
    ...
    let entries = [
        ...
        (sources.call_record_status, 4),
        (sources.param_reg_status, 4),
        (sources.intrinsic_call_status, 4),
        (sources.call_abi_status, 4),
        (sources.node_inst_count_status, 5),
        ...
        (sources.rodata_status, 4),
        (sources.rodata_len, 1),
