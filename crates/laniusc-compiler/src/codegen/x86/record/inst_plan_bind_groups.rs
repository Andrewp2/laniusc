...
pub(super) struct InstPlanBindGroupInputs<'a> {
    ...
    pub(super) enclosing_loop_node_a: &'a wgpu::Buffer,
    pub(super) enclosing_loop_node_b: &'a wgpu::Buffer,
...
pub(super) fn create_inst_plan_bind_groups(
    ...
    let InstPlanBindGroupInputs {
        ...
        enclosing_loop_node_a,
        enclosing_loop_node_b,
    ...
    let enclosing_loop_init = reflected_bind_group(
        device,
        ...
        &[
            ...
            (
                ...
                enclosing_loop_link_a.as_entire_binding(),
            ),
        ],
    )?;
    let enclosing_loop_step = step_pair_groups(
        device,
        "codegen.x86.enclosing_loop_step.bind_group",
        ...
        &[],
        StepNames {
            first_in: "x86_enclosing_loop_node_in",
            second_in: "x86_enclosing_loop_link_in",
            first_out: "x86_enclosing_loop_node_out",
            second_out: "x86_enclosing_loop_link_out",
        },
        StepPairs {
            first_a: enclosing_loop_node_a,
            first_b: enclosing_loop_node_b,
            second_a: enclosing_loop_link_a,
