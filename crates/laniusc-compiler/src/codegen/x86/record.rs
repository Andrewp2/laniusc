...
impl GpuX86CodeGenerator {
    ...
    fn record_from_hir(
        ...
        // ABI records are dead after instruction generation. Reuse their
        // token-indexed storage for virtual last-row bounds, initialized
        // immediately before the row-bound scatter pass.
        ...
        let rodata_scan_params_buf = scan_params(
            device,
            "codegen.x86.rodata_scan.params",
            hir_words,
            rodata_scan_blocks,
            hir_words,
        );
        ...
        record_initializers(InitializerInputs {
            ...
            match_result_dense_owner_buf: &match_result_dense_owner_buf,
            ...
            rodata_len_buf: &rodata_len_buf,
            rodata_status_buf: &rodata_status_buf,
        ...
        let EnumMatchBindGroups {
            ...
            EnumMatchBindGroupInputs {
                ...
                match_arm_record: &match_arm_record_buf,
                match_result_dense_owner: &match_result_dense_owner_buf,
                match_arm_owner: &match_arm_owner_buf,
                match_pattern_owner: &match_pattern_owner_buf,
                match_pattern_node_owner: &match_pattern_node_owner_buf,
                match_pattern_dense_owner: &match_result_dense_owner_buf,
                match_pattern_root_owner: &match_pattern_owner_buf,
                ...
                compact_executable_raw: &compact_executable_raw_buf,
        ...
        let SemanticRecordBindGroups {
            ...
            struct_field_widths: struct_field_widths_bind_group,
            struct_field_stream: struct_field_stream_bind_group,
            struct_records: struct_records_bind_group,
            array_element_rows: array_element_rows_bind_group,
            ...
            SemanticRecordInputs {
                ...
                match_arm_record_buf: &match_arm_record_buf,
                compact_hir_count_buf: enum_metadata.compact_hir_count,
                compact_hir_core_buf: enum_metadata.compact_hir_core,
                compact_hir_links_buf: enum_metadata.compact_hir_links,
                compact_match_arms_buf: enum_metadata.compact_match_arms,
                raw_to_compact_hir_buf: enum_metadata.raw_to_compact_hir,
                compact_match_arm_count_buf: enum_metadata.compact_match_arm_count,
                match_return_node_buf: &match_return_node_buf,
                match_arm_owner_buf: &match_arm_owner_buf,
                match_pattern_owner_buf: &match_pattern_owner_buf,
                match_result_value_owner_buf: &match_result_value_owner_buf,
                ...
                compact_executable_raw_buf: &compact_executable_raw_buf,
                match_pattern_first_variant_node_buf,
                match_pattern_first_payload_node_buf,
                ...
                struct_type_record_buf: &struct_type_record_buf,
                struct_field_width_by_node_buf: &struct_field_width_by_node_buf,
                struct_field_count_by_hir_buf: &struct_field_count_by_hir_buf,
                struct_field_base_by_hir_buf: &struct_field_base_by_hir_buf,
                struct_field_stream_index_by_node_buf: &struct_field_stream_index_by_node_buf,
                array_element_row_by_hir_buf: &array_element_row_by_hir_buf,
                struct_literal_field_row_by_hir_buf: &struct_literal_field_row_by_hir_buf,
                compact_expr_wrapper_buf: &compact_expr_wrapper_buf,
                struct_access_record_buf: &struct_access_record_buf,
                struct_store_record_buf: &struct_store_record_buf,
                struct_record_status_buf: &struct_record_status_buf,
                enum_type_record_buf: &enum_type_record_buf,
        ...
        let InstGenBindGroups {
            ...
            control_stmt: node_inst_gen_control_stmt_bind_group,
            ...
            InstGenBindGroupInputs {
                ...
                array_metadata: &array_metadata,
                compact_executable_raw: &compact_executable_raw_buf,
                compact_expr_wrapper: &compact_expr_wrapper_buf,
                array_element_row_by_hir: &array_element_row_by_hir_buf,
                struct_literal_field_row_by_hir: &struct_literal_field_row_by_hir_buf,
                enum_metadata: &enum_metadata,
                struct_metadata: &struct_metadata,
                expr_resolved_final: &expr_resolved_final_buf,
                visible_decl: visible_decl_buf,
                ...
                hir_call_arg_count: call_metadata.arg_count,
                hir_call_callee_node: call_metadata.callee_node,
                hir_member_receiver_node: call_metadata.member_receiver_node,
                call_arg_row_node: call_metadata.arg_row_node,
                call_arg_row_start: call_metadata.arg_row_start,
                call_arg_row_count: call_metadata.arg_row_count,
                intrinsic_call_record: intrinsic_call_record_buf,
                enum_value_record: &enum_value_record_buf,
                match_record: &match_record_buf,
                match_arm_record: &match_arm_record_buf,
        ...
        let EmitBindGroups {
            ...
            rodata_sizes: rodata_sizes_bind_group,
            ...
            EmitBindGroupInputs {
                ...
                rodata_scan_prefix_b: &rodata_scan_prefix_b_buf,
                text_status: &text_status_buf,
        ...
        record_metadata_and_call_dispatches(
            ...
            MetadataCallDispatchInputs {
                ...
                struct_field_widths_bind_group: &struct_field_widths_bind_group,
                struct_field_stream_bind_group: &struct_field_stream_bind_group,
                struct_records_bind_group: &struct_records_bind_group,
                array_element_rows_bind_group: &array_element_rows_bind_group,
        ...
        record_instruction_dispatches(
            ...
            InstructionDispatchInputs {
                ...
                node_inst_gen_control_stmt: &node_inst_gen_control_stmt_bind_group,
        ...
        retained_buffers.push(RetainedX86Buffer::from(
            rodata_scan_params_buf.into_buffer(),
        ));
        retained_buffers.push(RetainedX86Buffer::from(
        ...
        let mut retained_bind_groups = vec![
            ...
            node_inst_gen_control_stmt_bind_group,
        ...
        retained_bind_groups.extend(rodata_scan_block_bind_groups);
