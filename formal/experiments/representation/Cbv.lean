...
theorem comparisonAccepted :
 Reconstruction.Validated.checkedView laniusGrammar verifiedFrontendTokenScanParseView Parse.productions.lookup =
 some comparisonSurface := by cbv
theorem comparisonSound :
 ...
 Reconstruction.Validated.checkedView_sound laniusGrammar verifiedFrontendTokenScanParseView Parse.productions.lookup Parse.lookup_eq comparisonSurface comparisonAccepted
