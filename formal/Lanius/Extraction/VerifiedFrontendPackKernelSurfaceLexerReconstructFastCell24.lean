...
set_option maxRecDepth 100000
 ...
 theorem verifiedFrontendLexer_fast_proposed_items_drop24_kernel :
...
theorem verifiedFrontendLexer_fast_items_node24_production_kernel :
...
theorem verifiedFrontendLexer_fast_items_node24_item_kernel :
    artifactChildNode? verifiedFrontendLexerArtifact 6965 0 = some 5916 := by
  unfold artifactChildNode?
  rw [verifiedFrontendLexer_artifactNode_spine_kernel 4 (by omega)]
  rfl

theorem verifiedFrontendLexer_fast_items_node24_rest_kernel :
    artifactChildNode? verifiedFrontendLexerArtifact 6965 1 = some 6964 := by
  unfold artifactChildNode?
  rw [verifiedFrontendLexer_artifactNode_spine_kernel 4 (by omega)]
  rfl

theorem verifiedFrontendLexer_reconstruct_items_fast24_kernel :
  ...
  rw [verifiedFrontendLexer_fast_proposed_items_drop24_kernel]
  exact reconstructItems_cons_step
    verifiedFrontendLexer_fast_items_node24_production_kernel
    verifiedFrontendLexer_fast_items_node24_item_kernel
    verifiedFrontendLexer_fast_items_node24_rest_kernel
