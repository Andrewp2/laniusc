import Lanius.Extraction.VerifiedFrontend.Context.Materialized.Declaration.Certificate
import Lanius.Extraction.VerifiedFrontend.Context.Tables.Constants.Certificate
