import Lanius.Extraction.VerifiedFrontend.Surface.Lexer.Parse.Metadata
...
theorem verifiedFrontendLexer_parse_checked_kernel :
    checkParseArtifact verifiedFrontendLexerArtifact = true :=
  checkParseArtifact_of_checks verifiedFrontendLexerArtifact
    verifiedFrontendLexerParseRootKernel
    verifiedFrontendLexer_token_checked_kernel
    verifiedFrontendLexer_semantic_kinds_checked_kernel
    verifiedFrontendLexer_parse_nodes_checked_kernel
    verifiedFrontendLexerParseRootKernel_eq
    verifiedFrontendLexer_root_shape_checked_kernel
