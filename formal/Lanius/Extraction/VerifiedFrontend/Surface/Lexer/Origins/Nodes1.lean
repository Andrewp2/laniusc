...
theorem verifiedFrontendLexer_node_origins_1_checked_kernel :
    nodeOriginPathsValid verifiedFrontendLexerArtifact verifiedFrontendLexerView
      ((verifiedFrontendLexerOrigins.claims.nodes.drop 277).take 277)
      ((verifiedFrontendLexerOrigins.nodePaths.drop 277).take 277) = true := by
