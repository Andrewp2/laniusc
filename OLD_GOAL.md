...
---
Ok, let's work on that then. There are two tasks:

1. Build an appropriate compiler-graph architecture which allows us to track ownership on the GPU, tracking inputs, outputs, and read/write behavior.
