...
pub(super) struct InitialRecordBuffers {
    ...
    pub(super) func_meta_uniform_buf: wgpu::Buffer,
    pub(super) node_tree_status_buf: PooledStorageBuffer,
    pub(super) expr_resolved_final_buf: wgpu::Buffer,
    pub(super) node_func_buf: wgpu::Buffer,
    pub(super) func_owner_scan_local_prefix_buf: wgpu::Buffer,
    pub(super) func_owner_scan_block_sum_buf: wgpu::Buffer,
    pub(super) func_owner_scan_prefix_a_buf: wgpu::Buffer,
    pub(super) func_owner_scan_prefix_b_buf: wgpu::Buffer,
    pub(super) enum_value_record_rows: usize,
    pub(super) enum_type_record_buf: wgpu::Buffer,
    pub(super) enum_value_record_buf: wgpu::Buffer,
    pub(super) enum_record_status_buf: PooledStorageBuffer,
    pub(super) match_record_rows: usize,
    pub(super) match_record_buf: wgpu::Buffer,
    pub(super) match_arm_owner_buf: wgpu::Buffer,
    pub(super) match_return_node_buf: wgpu::Buffer,
    pub(super) match_pattern_owner_buf: wgpu::Buffer,
    pub(super) match_result_value_owner_buf: wgpu::Buffer,
    pub(super) match_pattern_node_owner_buf: wgpu::Buffer,
    pub(super) match_pattern_node_variant_buf: wgpu::Buffer,
    pub(super) match_pattern_node_payload_decl_buf: wgpu::Buffer,
    pub(super) node_inst_same_end_link_a_buf: wgpu::Buffer,
    pub(super) node_inst_same_end_link_b_buf: wgpu::Buffer,
}
...
pub(super) struct MetadataRecordBuffers {
    pub(super) match_pattern_first_use_node_buf: wgpu::Buffer,
    pub(super) needs_enclosing_return_records: bool,
    pub(super) enclosing_return_node_a_buf: wgpu::Buffer,
    pub(super) enclosing_return_node_b_buf: wgpu::Buffer,
    pub(super) enclosing_let_node_a_buf: wgpu::Buffer,
    pub(super) enclosing_let_node_b_buf: wgpu::Buffer,
    pub(super) match_pattern_first_variant_node_storage_buf: Option<wgpu::Buffer>,
    pub(super) match_pattern_first_payload_node_storage_buf: Option<wgpu::Buffer>,
    pub(super) aggregate_record_rows: usize,
    pub(super) struct_type_record_buf: wgpu::Buffer,
    pub(super) struct_access_record_buf: wgpu::Buffer,
    pub(super) struct_store_record_buf: wgpu::Buffer,
    pub(super) struct_record_status_buf: PooledStorageBuffer,
    pub(super) decl_layout_record_buf: wgpu::Buffer,
    pub(super) decl_layout_status_buf: PooledStorageBuffer,
    pub(super) decl_node_by_token_buf: wgpu::Buffer,
    pub(super) func_slot_by_index_buf: wgpu::Buffer,
    pub(super) func_slot_by_node_buf: wgpu::Buffer,
    pub(super) call_record_buf: wgpu::Buffer,
    pub(super) call_type_record_buf: wgpu::Buffer,
    pub(super) node_inst_count_info_buf: wgpu::Buffer,
    pub(super) node_inst_count_payload_buf: wgpu::Buffer,
    pub(super) call_record_status_buf: PooledStorageBuffer,
    pub(super) const_value_record_buf: wgpu::Buffer,
    pub(super) const_value_status_buf: PooledStorageBuffer,
    pub(super) const_value_status_uniform_buf: wgpu::Buffer,
    pub(super) param_reg_record_words: usize,
    pub(super) param_reg_record_buf: wgpu::Buffer,
    pub(super) param_reg_status_buf: PooledStorageBuffer,
    pub(super) param_reg_status_uniform_buf: wgpu::Buffer,
    pub(super) local_literal_record_buf: wgpu::Buffer,
    pub(super) local_literal_status_buf: PooledStorageBuffer,
    pub(super) local_literal_status_uniform_buf: wgpu::Buffer,
    pub(super) empty_param_record_buf: Option<wgpu::Buffer>,
    pub(super) node_inst_order_record_buf: wgpu::Buffer,
    pub(super) call_arg_lookup_record_buf: wgpu::Buffer,
...
pub(super) struct InstructionRecordBuffers {
    ...
    pub(super) node_inst_scan_local_prefix_buf: wgpu::Buffer,
    pub(super) node_inst_range_start_buf: wgpu::Buffer,
    pub(super) node_inst_range_info_buf: wgpu::Buffer,
    pub(super) node_inst_range_status_buf: PooledStorageBuffer,
    pub(super) node_inst_subtree_bound_start_buf: wgpu::Buffer,
    pub(super) node_inst_subtree_bound_end_buf: wgpu::Buffer,
    ...
    pub(super) virtual_func_slot_buf: wgpu::Buffer,
    pub(super) virtual_value_def_status_buf: PooledStorageBuffer,
    pub(super) virtual_live_start_buf: wgpu::Buffer,
    pub(super) virtual_live_end_buf: wgpu::Buffer,
    pub(super) virtual_liveness_status_buf: PooledStorageBuffer,
    pub(super) virtual_next_call_a_buf: wgpu::Buffer,
    pub(super) virtual_next_call_b_buf: wgpu::Buffer,
    pub(super) virtual_next_call_status_buf: PooledStorageBuffer,
    pub(super) func_param_reg_mask_status_buf: PooledStorageBuffer,
    pub(super) virtual_regalloc_param_rank_mask_buf: wgpu::Buffer,
    pub(super) virtual_phys_reg_buf: wgpu::Buffer,
    pub(super) virtual_call_live_reg_mask_buf: wgpu::Buffer,
    ...
    pub(super) text_len_buf: wgpu::Buffer,
    pub(super) text_status_buf: PooledStorageBuffer,
    pub(super) text_scan_words: usize,
    pub(super) text_scan_blocks: usize,
    pub(super) text_scan_block_sum_buf: wgpu::Buffer,
    pub(super) text_scan_prefix_a_buf: wgpu::Buffer,
