...
pub struct GpuSourcePackCodegenObjectBuildHandle {
    pub(super) job: SourcePackJob,
    pub(super) source_files: Vec<ExplicitSourcePathFile>,
    pub(super) library_interface_artifact: SourcePackFilesystemArtifactPath,
    pub(super) dependency_interfaces: GpuSourcePackDependencyInterfaceSummary,
}
...
impl<'compiler, 'gpu> GpuSourcePackArtifactExecutor<'compiler, 'gpu> {
    ...
    pub(super) fn write_descriptor_artifact_for_suffix(
        ...
        let path = source_pack_filesystem_artifact_path(&self.artifact_root, &key)?;
        ...
        write_source_pack_filesystem_file_atomically(
            &path,
            &bytes,
            "GPU source-pack descriptor artifact",
        )?;
    ...
    pub(super) fn validate_existing_path_artifact_batch(
        ...
        stage: &str,
        owner_index: usize,
        artifacts: &[SourcePackFilesystemArtifactPath],
    ) -> Result<(), CompileError> {
...
impl<'compiler, 'gpu> SourcePackPathAsyncPagedArtifactBuildExecutor
...
pub(super) struct OwnedLexerParserInputBuffers {
    pub(super) source_len: u32,
    pub(super) in_bytes: wgpu::Buffer,
    pub(super) tokens_out: wgpu::Buffer,
    pub(super) token_count: wgpu::Buffer,
    pub(super) token_file_id: wgpu::Buffer,
}
...
impl<'gpu> GpuCompiler<'gpu> {
    ...
    pub(super) async fn type_check_expanded_source(&self, src: &str) -> Result<(), CompileError> {
        let _resident_guard = self.resident_pipeline_lock.lock().await;
        self.lexer
    ...
    pub async fn compile_explicit_source_pack_paths_legacy_in_memory_to_wasm<SP, UP>(
        &self,
        stdlib_paths: &[SP],
        user_paths: &[UP],
    ) -> Result<Vec<u8>, CompileError>
    ...
    #[deprecated(
        note = "compile_explicit_source_pack_paths_to_wasm whole-loads source files; use prepare_ordered_explicit_source_library_path_dependency_streams_filesystem_artifact_build_with_shard_limits_for_target plus submit_gpu_descriptor_work_queue_step_using for scalable builds"
    )]
    ...
    where
        ...
        UP: AsRef<Path>,
    {
        self.compile_explicit_source_pack_paths_legacy_in_memory_to_wasm(stdlib_paths, user_paths)
            .await
    }

    pub async fn compile_explicit_source_libraries_legacy_in_memory_to_wasm<P>(
        &self,
    ...
    #[deprecated(
        note = "compile_explicit_source_libraries_to_wasm whole-loads source files; use ordered path dependency streams plus filesystem work-queue descriptor submission for scalable builds"
    )]
    pub async fn compile_explicit_source_libraries_to_wasm<P>(
        &self,
        libraries: Vec<ExplicitSourceLibraryPaths<P>>,
    ) -> Result<Vec<u8>, CompileError>
    where
        P: AsRef<Path>,
    {
        self.compile_explicit_source_libraries_legacy_in_memory_to_wasm(libraries)
            .await
    }
    ...
    pub async fn execute_prepared_source_pack_filesystem_work_queue_worker_run_to_wasm_with_gpu_descriptors(
        ...
        self.execute_prepared_source_pack_filesystem_work_queue_worker_run_with_gpu_descriptors_for_target(
            artifact_root,
    ...
    pub async fn execute_prepared_source_pack_filesystem_work_queue_worker_step_to_wasm_with_gpu_descriptors(
        ...
        self.execute_prepared_source_pack_filesystem_work_queue_worker_step_with_gpu_descriptors_for_target(
            artifact_root,
            SourcePackArtifactTarget::Wasm,
            worker_id,
            lease_expires_unix_nanos,
        ...
        P: AsRef<Path>,
    {
        ...
        self.execute_ordered_explicit_source_library_path_streams_filesystem_artifact_build_work_queue_worker_step_with_gpu_descriptors_for_target(
            path_streams,
            artifact_root,
            limits,
            batch_limits,
    ...
    where
        ...
        P: AsRef<Path>,
    {
        self.execute_ordered_explicit_source_libraries_filesystem_artifact_build_work_queue_worker_step_with_gpu_descriptors_for_target(
            libraries,
            artifact_root,
            limits,
            batch_limits,
        ...
        P: AsRef<Path>,
    {
        ...
        SourcePackFilesystemPreparedArtifactBuild::new(&artifact_root, target)
    ...
    where
        ...
        P: AsRef<Path>,
    {
        self.execute_ordered_explicit_source_library_path_streams_filesystem_artifact_build_work_queue_worker_run_with_gpu_descriptors_for_target(
            libraries,
            artifact_root,
            limits,
            batch_limits,
    ...
    where
        ...
        P: AsRef<Path>,
    {
        self.execute_ordered_explicit_source_library_path_dependency_streams_filesystem_artifact_build_work_queue_worker_run_with_gpu_descriptors_for_target(
            libraries,
            artifact_root,
            limits,
            batch_limits,
    ...
    where
        ...
        P: AsRef<Path>,
    {
        self.execute_ordered_explicit_source_library_path_dependency_streams_filesystem_artifact_build_work_queue_worker_step_with_gpu_descriptors_for_target(
            libraries,
            artifact_root,
            limits,
            batch_limits,
    ...
    >(
        ...
        user_paths: &[UP],
        artifact_root: impl Into<PathBuf>,
        _limits: CodegenUnitLimits,
        _batch_limits: SourcePackJobBatchLimits,
        _shard_limits: SourcePackBuildShardLimits,
        target: SourcePackArtifactTarget,
        worker_id: impl Into<String>,
        max_items: usize,
        lease_expires_unix_nanos: Option<u128>,
    ...
    where
        ...
        UP: AsRef<Path>,
    {
        self.execute_explicit_source_pack_paths_filesystem_artifact_build_work_queue_worker_run_with_gpu_descriptors_for_target(
            stdlib_paths,
            user_paths,
            artifact_root,
            limits,
    ...
    where
        ...
        UP: AsRef<Path>,
    {
        self.execute_explicit_source_pack_paths_filesystem_artifact_build_work_queue_worker_step_with_gpu_descriptors_for_target(
            stdlib_paths,
            user_paths,
            artifact_root,
            limits,
    ...
    pub(super) async fn compile_expanded_source_to_wasm(
        &self,
        src: &str,
    ) -> Result<Vec<u8>, CompileError> {
        let _resident_guard = self.resident_pipeline_lock.lock().await;
    ...
    #[allow(clippy::too_many_arguments)]
    pub(super) fn record_x86_from_parse_buffers_with_codegen(
        &self,
        device: &wgpu::Device,
        queue: &wgpu::Queue,
    ...
    pub(super) fn x86_external_scratch_from_frontend_and_codegen_buffers<'a>(
    ...
    pub async fn compile_explicit_source_pack_paths_legacy_in_memory_to_x86_64<SP, UP>(
        &self,
        stdlib_paths: &[SP],
        user_paths: &[UP],
    ) -> Result<Vec<u8>, CompileError>
    ...
    #[deprecated(
        note = "compile_explicit_source_pack_paths_to_x86_64 whole-loads source files; use prepare_ordered_explicit_source_library_path_dependency_streams_filesystem_artifact_build_with_shard_limits_for_target plus submit_gpu_descriptor_work_queue_step_using for scalable builds"
    )]
    ...
    where
        ...
        UP: AsRef<Path>,
    {
        self.compile_explicit_source_pack_paths_legacy_in_memory_to_x86_64(stdlib_paths, user_paths)
            .await
    }

    pub async fn compile_explicit_source_libraries_legacy_in_memory_to_x86_64<P>(
        &self,
        libraries: Vec<ExplicitSourceLibraryPaths<P>>,
    ) -> Result<Vec<u8>, CompileError>
    where
    ...
    #[deprecated(
        note = "compile_explicit_source_libraries_to_x86_64 whole-loads source files; use ordered path dependency streams plus filesystem work-queue descriptor submission for scalable builds"
    )]
    pub async fn compile_explicit_source_libraries_to_x86_64<P>(
        &self,
        libraries: Vec<ExplicitSourceLibraryPaths<P>>,
    ) -> Result<Vec<u8>, CompileError>
    where
        P: AsRef<Path>,
    {
        self.compile_explicit_source_libraries_legacy_in_memory_to_x86_64(libraries)
            .await
    }

    #[allow(clippy::too_many_arguments)]
    pub(super) fn record_typecheck_from_parse_buffers(
        &self,
        device: &wgpu::Device,
        queue: &wgpu::Queue,
        encoder: &mut wgpu::CommandEncoder,
    ...
    #[allow(dead_code)]
    pub(super) fn typecheck_external_scratch_from_frontend_buffers<'a>(
    ...
    pub(super) fn reparse_x86_parser_buffers_from_lexer_inputs(
        &self,
        device: &wgpu::Device,
        queue: &wgpu::Queue,
    ...
    pub(super) async fn compile_expanded_source_to_x86_64(
        &self,
        src: &str,
    ) -> Result<Vec<u8>, CompileError> {
        let _resident_guard = self.resident_pipeline_lock.lock().await;
...
pub(super) fn prepare_source_for_gpu(src: &str) -> Result<String, CompileError> {
    Ok(src.to_string())
}

pub(super) fn prepare_source_for_gpu_from_path(
    path: impl AsRef<Path>,
