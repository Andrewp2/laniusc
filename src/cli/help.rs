...
pub(crate) fn print_version() {
    println!(
        ...
        option_env!("LANIUS_SHADER_ARTIFACT_COUNT").unwrap_or("unknown"),
        option_env!("LANIUS_SHADER_ARTIFACT_MAX_BYTES").unwrap_or("unknown"),
        option_env!("LANIUS_SHADER_ARTIFACT_MAX_NAME").unwrap_or("unknown"),
        option_env!("LANIUS_SHADER_SIZE_GUARD_STATUS").unwrap_or("unknown"),
        option_env!("LANIUS_SHADER_SIZE_GUARD_MAX_BYTES").unwrap_or("unknown"),
