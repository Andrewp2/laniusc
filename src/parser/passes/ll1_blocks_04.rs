...
crate::gpu::passes_core::impl_static_shader_pass!(
    LL1BlocksFlattenEmitPass,
    label: "ll1_blocks_04_flatten_emit",
    shader: "ll1_blocks_04_flatten_emit"
);

impl Pass<ParserBuffers, crate::parser::debug::DebugOutput> for LL1BlocksFlattenEmitPass {
