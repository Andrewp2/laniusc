...
pub struct ParserBuffers {
    ...
    pub ll1_params_base: super::super::passes::ll1_blocks_01::LL1BlocksParams,
    pub params_ll1_blocks: LaniusBuffer<super::super::passes::ll1_blocks_01::LL1BlocksParams>,
